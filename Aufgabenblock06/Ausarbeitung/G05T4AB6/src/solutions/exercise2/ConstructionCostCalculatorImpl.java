...
public class ConstructionCostCalculatorImpl implements ConstructionCostCalculator, ExerciseSubmission {
	...
	private Multiplicator beach(ProducerType prod) {
		...
		default: 				throw new IllegalArgumentException(prod.name()+" is not able be built on "+ElementType.BEACH);
		}
	}
	...
	private Multiplicator grass(ProducerType prod) {
		...
		default: 				throw new IllegalArgumentException(prod.name()+" is not able be built on "+ElementType.GRASSLAND);
		}
	}
	...
	private Multiplicator mountain(ProducerType prod) {
		...
		default: 				throw new IllegalArgumentException(prod.name()+" is not able be built on "+ElementType.MOUNTAIN);
		}
	}
	...
	private Multiplicator river(ProducerType prod) {
		...
		default: 				throw new IllegalArgumentException(prod.name()+" is not able be built on "+ElementType.RIVER);
		}
	}
	...
	private Multiplicator sea(ProducerType prod) {
		...
		default: 				throw new IllegalArgumentException(prod.name()+" is not able be built on "+ElementType.SEA);
		}
	}
